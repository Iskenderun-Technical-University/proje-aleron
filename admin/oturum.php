                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="kytders.php" target="orta">Ders Kayıt</a></li>
                                    <li><a href="kytalan.php" target="orta">Alan Kayıt</a></li>
                                    <li><a href="kytsinif.php" target="orta">Sınıf Kayıt</a></li>
                                    <li><a href="kytogretmen.php" target="orta">Öğretmen Kayıt</a></li>
                                    <li><a href="kytkonum.php" target="orta">Konum Kayıt</a></li>
                                    <li><a href="program.php?snc=1" target="orta">Ders Programı</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="kytnobet.php" target="orta">Nöbet Yerleri</a></li>
                                    <li><a href="nobetpro.php" target="orta">Nöbet Programı</a></li>
                                </ul>
                            </li>
							<!--
                            <li>
...
-->
                            ...
                            <li class="menu-title">HIZLI MENÜ</li>
...
<!--
						...
						<p>&nbsp;</p>
							<center><h3 style="color: white;"><a href="kontrol.php?veri=0"><i class="fe-log-out"></i><span> ÇIKIŞ </span></a></h3></center>
                    </div>
                    <!-- End Sidebar -->
