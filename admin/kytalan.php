...
?>
<body>
<form id="form1" name="form1" method="post" action="kontrol.php?veri=13">
<table width="550" height="150" border="1" align="center" cellpadding="2" cellspacing="2" bordercolor="#64C5B1" style="border-radius: 15px;">
    <tbody>
      <tr>
        <td colspan="2" align="center" style="border-top-left-radius: 15px;border-top-right-radius: 15px;">ALAN/BÖLÜM KAYIT</td>
      </tr>
      <tr>
        <td>Alan/Bölüm Adı:</td>
	...
	<table width="400" border="0" align="center"><caption><h3>Kayıtlı Alanlar</h3></caption>		
	  <tbody>
		  <tr><td colspan="2"><hr></td></tr>
<?php
			$listele=mysqli_query($baglan, "select * from alanlar_tbl order by alan");
			while($oku=mysqli_fetch_assoc($listele)){
				echo "<tr><td>".$oku["alan"]."</td><td width='40'><a href='kontrol.php?veri=14&id=".$oku["id"]."' title='Sil'><img src='images/delete.png' width='30' height='30'></a></td></tr>";
			}
			mysqli_close($baglan);
	?>      
		</tbody>
